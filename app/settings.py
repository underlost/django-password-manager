...
sys.path.append(os.path.join(BASE_DIR, 'app/util'))
sys.path.append(os.path.join(BASE_DIR, 'app/vendor'))
...
#Site Settings
SITE_NAME = os.environ.get('SITE_NAME', 'Passe')
SITE_DESC =  os.environ.get('SITE_DESC', 'Yet another password manager.')
